...
<?php include "nav.php" ?>
<main class="flex flex-row justify-center align-middle">
    <div class="flex flex-col lg:flex-row ">
        <div>
            <div class="text-2xl m-4 font-bold">Contact</div>
            ...
            <div class="p-4 flex flex-row">
                ...
                <div class="shadow-gray-300 bg-gray-100 p-2 rounded">
                    040 - 202 40 95
                </div>
            </div>
        </div>
            ...
            <form class="mb-4 rounded bg-white px-8 pt-6 pb-8 shadow-md">
                <div>
                    <div class="lg:flex lg:flex-row">
                        ...
                        <div class="mb-4 mr-4">
                            <label class="mb-2 block text-sm font-bold text-gray-700" for="subject">Onderwerp</label>
                            <input class="w-full appearance-none rounded border px-3 py-2 leading-tight text-gray-700 shadow focus:shadow-outline focus:outline-none"
                                   id="subject"/>
                        </div>
                    </div>
